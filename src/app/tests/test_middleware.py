...
def test_admin_whitelist_middleware_raises_permission_denied_for_admin_pages_if_ip_not_allowed(mock_settings):
    # Given
...
@mock.patch('app.middleware.settings')
def test_admin_whitelist_middleware_returns_get_response_for_admin_pages_if_ip_allowed(mock_settings):
    # Given
    allowed_ip_address = '10.0.0.1'
