...
class CreateUpdateUserPermissionSerializerABC(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        instance = super(CreateUpdateUserPermissionSerializerABC, self).create(validated_data)
        instance.permissions.set(permissions)
        return instance

    def update(self, instance, validated_data):
        permissions = validated_data.pop('permissions', [])
        instance = super(CreateUpdateUserPermissionSerializerABC, self).update(instance, validated_data)
        instance.permissions.set(permissions)
        return instance
