...
{/* prettier-ignore */}<a href={`https://www.tsdocs.dev/docs/flagsmith-nodejs/${NodejsVersion()}/classes/EnvironmentModel.html`}>EnvironmentModel</a>
object:

```typescript
import type { BaseOfflineHandler } from 'flagsmith-nodejs';
