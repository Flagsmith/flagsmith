...
[Identities](/flagsmith-concepts/identities) , using the **forIdentity** parameter.

To retrieve a trait for a particular identity (see [Traits](/flagsmith-concepts/identities#identity-traits)):
