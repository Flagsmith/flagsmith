...
For self-hosted instances you run the MCP server yourself as part of your Flagsmith deployment; see
[Self-hosting the MCP Server](/deployment-self-hosting/mcp-server). Use your MCP server base URL wherever the examples
below use `https://mcp.flagsmith.com`.
