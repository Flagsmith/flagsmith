...
- Beta release of both [Data Dog](https://docs.flagsmith.com/integrations/apm/datadog) and
  [Amplitude](https://docs.flagsmith.com/integrations/analytics/amplitude) integrations.
