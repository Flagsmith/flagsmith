...
Once this task has run, and you have made some flag evaluations with analytics enabled (see documentation [here](/experimentation/flag-analytics) for information on this), you should see data in the 'Analytics' tab against each feature in your dashboard.
