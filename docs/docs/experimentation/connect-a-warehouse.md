...
sends a test event on your behalf. The connection shows **Pending Connection** while the event is on its way, and
...
- **Pending Connection**: a test event is on its way.
