...
[CLI](/flagsmith-integration/CLI) and offline hander in your build pipelines.

The main steps to achieving this are as follows:

1. Install the [CLI](/flagsmith-integration/CLI) `npm i flagsmith-cli --save-dev`
...
| `realtime?:boolean`                                                                         |                                                                                   Whether to listen for [Real Time Flag events](/performance/real-time-flags)                                                                                    |          |                                                 false |
...
| `enableAnalytics?: boolean`                                                                 |                                                                     [Enable sending flag analytics](/experimentation/flag-analytics) for getValue and hasFeature evaluations.                                                                     |          |                                                 false |
...
| <code>setState(state: IState)=>void</code>                                                                                                          |                              Set the current state of flagsmith, [useful in NextJS / isomorphic applications.](/flagsmith-integration/client-side-sdks/nextjs-and-ssr) e.g. `flagsmith.setState({identity: 'mary@mycompany.com'})`.                              |
