...
All fields mentioned are not part of the response generated by the [Edge API](/sdk-api).
...
Responses generated by [Edge API](/sdk-api) already excludes all the above-mentioned fields apart from
`traits`
