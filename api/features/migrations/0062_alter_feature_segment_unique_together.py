...
current_index_constraint_name = (
    "features_featuresegment_feature_id_environment_i_e5499ca3_uniq"
)
new_index_constraint_name = (
    "features_featuresegment_feature_id_environment_i_f1fde686_uniq"
)
...
_add_constraint_reverse_sql = (
    f"ALTER TABLE features_featuresegment DROP CONSTRAINT {new_index_constraint_name};"
)
        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                PostgresOnlyRunSQL(
                    ...
                    reverse_sql=_drop_constraint_reverse_sql_add_constraint,
                ),
                PostgresOnlyRunSQL(
                    migrations.RunSQL.noop,
                    reverse_sql=_drop_constraint_reverse_sql_create_index,
                ),
                PostgresOnlyRunSQL(
                    _create_index_sql, reverse_sql=_create_index_reverse_sql
                ),
                PostgresOnlyRunSQL(
                    _add_constraint_sql, reverse_sql=_add_constraint_reverse_sql
                ),
            ],
        )
    ]
