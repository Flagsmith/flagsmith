        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        help_text="JSON blob describing the feature states that should be created when the change request is published",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        help_text="JSON blob describing the feature states that should be updated when the change request is published",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        help_text="JSON blob describing the segment overrides for whichthe segment overrides should be deleted when the change request is published",
                        null=True,
                    ),
                ),
                (
