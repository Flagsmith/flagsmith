...
def add_change_request_permissions(apps, schema_editor):  # type: ignore[no-untyped-def]
...
def remove_change_request_permissions(apps, schema_editor):  # type: ignore[no-untyped-def]
    PermissionModel = apps.get_model("permissions", "PermissionModel")
