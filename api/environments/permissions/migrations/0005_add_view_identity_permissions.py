...
def add_view_identities_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
...
def remove_view_identities_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
    PermissionModel = apps.get_model("permissions", "PermissionModel")
