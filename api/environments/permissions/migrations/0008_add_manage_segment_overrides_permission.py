...
def add_manage_segment_overrides_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
...
def remove_manage_segment_overrides_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
    PermissionModel = apps.get_model("permissions", "PermissionModel")
