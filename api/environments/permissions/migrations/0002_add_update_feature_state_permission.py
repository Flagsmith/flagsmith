...
def add_update_feature_state_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
...
def remove_update_feature_state_permission(apps, schema_editor):  # type: ignore[no-untyped-def]
    PermissionModel = apps.get_model("permissions", "PermissionModel")
