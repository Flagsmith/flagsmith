...
def create_permissions(apps: Apps, schema_editor: BaseDatabaseSchemaEditor):  # type: ignore[no-untyped-def]
...
def remove_permissions(apps: Apps, schema_editor: BaseDatabaseSchemaEditor):  # type: ignore[no-untyped-def]
