...
from permissions.models import (
    ORGANISATION_PERMISSION_TYPE,
    PROJECT_PERMISSION_TYPE,
)


def move_permission_to_project(apps: Apps, schema_editor: BaseDatabaseSchemaEditor):  # type: ignore[no-untyped-def]
...
def move_permission_to_organisation(  # type: ignore[no-untyped-def]
