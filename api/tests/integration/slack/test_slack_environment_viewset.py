...
def test_posting_env_config_return_400_when_slack_project_config_does_not_exist(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_posting_env_config_calls_join_channel(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker,
    admin_client,
    environment,
    environment_api_key,
...
def test_update_environment_config_calls_join_channel(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker,
    admin_client,
    environment,
    environment_api_key,
...
def test_update_environment_config_returns_400_if_join_channel_raises_slack_channel_join_error(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker,
    admin_client,
    environment,
    environment_api_key,
...
def test_get_environment_config_list_returns_200(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_get_environment_config_returns_200(  # type: ignore[no-untyped-def]  # noqa: FT003
    admin_client, environment, environment_api_key, slack_environment_config
):
    # Given
    url = reverse(
