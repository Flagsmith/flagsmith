...
def test_slack_oauth_flow_returns_401_if_secret_is_invalid(  # type: ignore[no-untyped-def]  # noqa: FT003,FT004
...
def test_slack_oauth_flow(  # type: ignore[no-untyped-def]  # noqa: FT003,FT004
...
def test_slack_oauth_callback_returns_400_if_redirect_url_is_not_found_in_session(  # type: ignore[no-untyped-def]  # noqa: FT003,FT004
...
def test_slack_oauth_init_returns_401_for_user_that_does_not_have_access_to_the_environment(  # type: ignore[no-untyped-def]  # noqa: E501,FT003,FT004
