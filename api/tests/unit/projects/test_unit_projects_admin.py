...
def test_project_admin_delete_all_segments(organisation: "Organisation"):  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_project_admin_has_delete_all_segments_permission(  # type: ignore[no-untyped-def]  # noqa: FT003,FT004
