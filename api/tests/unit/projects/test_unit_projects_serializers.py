...
def test_ProjectListSerializer_get_migration_status_returns_migration_not_applicable_if_not_configured(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
...
def test_ProjectListSerializer_get_migration_status_returns_migration_completed_for_new_projects(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker, project, settings
):
    # Given
...
def test_ProjectListSerializer_get_migration_status_calls_migrator_with_correct_arguments_for_old_projects(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker, project, settings
):
    # Given
    settings.PROJECT_METADATA_TABLE_NAME_DYNAMO = "project_metadata_table"
...
def test_ProjectListSerializer_get_use_edge_identities(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_ProjectRetrieveSerializer_get_use_edge_identities(  # type: ignore[no-untyped-def]  # noqa: FT003
    project, migration_status, expected
):
    # Given
