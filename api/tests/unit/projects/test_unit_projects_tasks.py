...
def test_migrate_project_environments_to_v2__calls_expected(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_migrate_project_environments_to_v2__expected_status_on_error(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker: MockerFixture,
    project_v2_migration_in_progress: Project,
):
    # Given
...
def test_handle_cascade_delete(  # noqa: FT003
    project: Project,
