...
def test_dynatrace_initialized_correctly():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
    api_key = "123key"
...
def test_dynatrace_when_generate_event_data_with_correct_values_then_success(  # noqa: FT003
...
def test_dynatrace_when_generate_event_data_with_missing_author_then_success():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
    log = "some log data"
...
def test_dynatrace_when_generate_event_data_with_missing_environment_then_success(  # type: ignore[no-untyped-def]  # noqa: FT003
