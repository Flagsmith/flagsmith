...
def test_base_environment_integration_model_serializer_save_updates_existing_if_soft_deleted(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    environment,
):
    """
...
def test_base_project_integration_model_serializer_save_updates_existing_if_soft_deleted(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    project,
):
    """
