...
def test_grafana_organisation_view__create_configuration__existing__return_expected(  # noqa: FT003
    admin_client_new: APIClient,
    organisation: Organisation,
...
def test_grafana_organisation_view__create_configuration__non_admin__return_expected(  # noqa: FT003
...
def test_grafana_organisation_view__get_configuration__non_admin__return_expected(  # noqa: FT003
    staff_client: APIClient,
    organisation: Organisation,
    grafana_organisation_configuration: GrafanaOrganisationConfiguration,
) -> None:
...
def test_grafana_organisation_view__delete_configuration__non_admin__return_expected(  # noqa: FT003
    staff_client: APIClient,
    organisation: Organisation,
    grafana_organisation_configuration: GrafanaOrganisationConfiguration,
) -> None:
