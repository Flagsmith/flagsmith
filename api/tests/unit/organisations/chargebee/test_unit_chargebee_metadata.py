...
def test_add_chargebee_object_meta_data():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_multiply_chargebee_object_metadata():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_multiply_chargebee_object_metadata_works_for_null_values():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
