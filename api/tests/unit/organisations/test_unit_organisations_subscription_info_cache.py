...
def test_update_caches(mocker, organisation, chargebee_subscription, settings):  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_update_caches_empty(  # noqa: FT003
