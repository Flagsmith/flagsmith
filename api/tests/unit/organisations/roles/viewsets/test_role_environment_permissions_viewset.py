...
def test_create_environment_permissions_for_role(
...
def test_retrieve_environment_permissions_for_role(
...
def test_list_environment_permissions_for_role(
    admin_client, role, environment, organisation, role_environment_permission
):
    # Given
    base_url = reverse(
...
def test_update_environment_permissions_for_role(
    admin_client, role, environment, organisation, role_environment_permission
):
    # Given
    url = reverse(
...
def test_delete_environment_permissions_for_role(
    admin_client, role, environment, organisation, role_environment_permission
):
    # Given
    url = reverse(
...
def test_create_environment_permissions_for_role_with_environment_from_different_organisation_returns_400(
    admin_client,
    role,
    environment,
    organisation,
