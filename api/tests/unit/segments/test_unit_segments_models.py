...
def test_Condition_str__returns_readable_representation_of_condition(  # noqa: FT003
    segment: Segment,
...
def test_LiveSegmentManager__returns_only_highest_version_of_segments(  # noqa: FT003
    segment: Segment,
) -> None:
    # Given
...
def test_SegmentRule_clean__validates_rule_has_only_one_parent(  # noqa: FT003
...
def test_SegmentRule_get_skip_create_audit_log__returns_true(  # noqa: FT003
    segment: Segment,
) -> None:
    # Given
...
def test_Segment_clone__can_create_standalone_segment_clone(  # noqa: FT003
    segment: Segment,
) -> None:
    # Given
    segment.version = 5
...
def test_Segment_get_skip_create_audit_log__system_segment__returns_true(  # noqa: FT004
