...
def test_calling_migrate_to_edge_calls_migrate_identities_with_correct_arguments(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker,
):
    # Given
    project_id = 1
...
def test_calling_migrate_to_edge_raises_command_error_if_identities_are_already_migrated(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker,
):
    # Given
    project_id = 1
