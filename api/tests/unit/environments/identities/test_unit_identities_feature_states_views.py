...
def test_user_without_update_feature_state_permission_cannot_create_identity_feature_state(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    client,
    organisation_one,
...
def test_user_with_update_feature_state_permission_can_update_identity_feature_state(  # type: ignore[no-untyped-def]  # noqa: FT003
    organisation_one_project_one_environment_one,
    organisation_one_project_one_feature_one,
    organisation_one_project_one,
    organisation_one_user,
...
def test_user_with_view_environment_permission_can_retrieve_all_feature_states_for_identity(  # noqa: FT003
    environment: Environment,
    identity: Identity,
...
def test_identity_clone_flag_states_from(  # noqa: FT003
    project: Project,
    environment: Environment,
    admin_client: Client,
) -> None:
