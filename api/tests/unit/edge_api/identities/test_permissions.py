...
def test_edge_identity_with_identifier_view_permissions__has_permission_called__delegates_to_environment_permission(  # type: ignore[no-untyped-def]  # noqa: E501
    environment,
    mocker,
):
    # Given
