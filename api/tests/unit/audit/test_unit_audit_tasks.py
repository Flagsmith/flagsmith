...
def test_create_audit_log_from_historical_record_does_nothing_if_no_user_or_api_key(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker,
    monkeypatch,
):
    # Given
...
def test_create_audit_log_from_historical_record_does_nothing_if_no_log_message(  # type: ignore[no-untyped-def]  # noqa: FT003
    mocker,
    monkeypatch,
):
    # Given
...
def test_create_audit_log_from_historical_record_does_nothing_if_get_skip_create_audit_log_true(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker,
    monkeypatch,
):
    # Given
...
def test_create_audit_log_from_historical_record_creates_audit_log_with_correct_fields(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    mocker,
    monkeypatch,
):
    # Given
...
def test_create_segment_priorities_changed_audit_log(  # noqa: FT003
    admin_user: FFAdminUser,
...
def test_create_segment_priorities_changed_audit_log_does_not_create_audit_log_for_versioned_feature_segments(  # noqa: FT003
    admin_user: FFAdminUser,
    feature_segment: FeatureSegment,
    feature: Feature,
...
def test_create_feature_state_went_live_audit_log(  # noqa: FT003
...
def test_create_feature_state_updated_by_change_request_audit_log(  # noqa: FT003
    change_request_feature_state: FeatureState,
) -> None:
    # Given
...
def test_create_feature_state_updated_by_change_request_audit_log_does_nothing_if_feature_state_deleted(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
...
def test_create_feature_state_wen_live_audit_log_does_nothing_if_feature_state_deleted(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
    change_request_feature_state,
):
    # Given
    message = FEATURE_STATE_WENT_LIVE_MESSAGE % (
