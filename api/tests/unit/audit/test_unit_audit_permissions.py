...
def test_organisation_audit_log_permission_has_permission_organisation_admin(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_organisation_audit_log_permission_has_permission_organisation_user_without_permission(  # type: ignore[no-untyped-def]  # noqa: E501,FT003
...
def test_project_audit_log_permission_has_permission_project_admin(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_project_audit_log_permission_has_permission_project_user_with_permission(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_project_audit_log_permission_has_permission_project_user_without_permission(  # type: ignore[no-untyped-def]  # noqa: FT003
