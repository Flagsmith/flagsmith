...
def test_deactivate_already_deactivated_mfa_returns_400(
    admin_client: APIClient, mfa_app_method: MFAMethod
):
    # Given
...
def test_activate_mfa_with_existing_mfa_returns_400(
    admin_client: APIClient, mfa_app_method: MFAMethod
):
    # Given
...
def test_activate_confirm_already_active_mfa_returns_400(
    admin_client: APIClient, mfa_app_method: MFAMethod
):
    # Given
    totp = pyotp.TOTP(mfa_app_method.secret)
...
def test_re_activate_confirm_deactive_mfa_creates_new_backup_codes(
...
def test_activate_confirm_mfa_for_different_user_retuns_400(
...
def test_activate_confirm_with_wrong_code_returns_400(
    admin_client: APIClient, mfa_app_method: MFAMethod
):
    # Given
    mfa_app_method.is_active = False
...
def test_login_with_invalid_mfa_code_returns_401(
...
def test_login_with_invalid_mfa_token_returns_401(
