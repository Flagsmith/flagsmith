...
def test_convert_response_data_to_dictionary_success():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_convert_response_data_to_dictionary_fail():  # type: ignore[no-untyped-def]  # noqa: FT003,FT004
    # Given
...
def test_get_first_and_last_name_success():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_get_first_and_last_name_too_many_names():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_get_first_and_last_name_too_few_names():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
    full_name = "wall-e"
