...
def test_organisation_admin_can_list_features(  # noqa: FT003
...
def test_project_admin_can_list_features(  # noqa: FT003
...
def test_project_user_with_read_access_can_list_features(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
...
def test_organisation_admin_can_create_feature(  # noqa: FT003
    admin_user: FFAdminUser,
    project: Project,
) -> None:
    # Given
...
def test_project_admin_can_create_feature(  # noqa: FT003
...
def test_project_user_with_create_feature_permission_can_create_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
    organisation: Organisation,
) -> None:
...
def test_project_user_without_create_feature_permission_cannot_create_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
) -> None:
    # Given
...
def test_organisation_admin_can_view_feature(  # noqa: FT003
    admin_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_project_admin_can_view_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
    feature: Feature,
) -> None:
...
def test_project_user_with_view_project_permission_can_view_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
    with_project_permissions: WithProjectPermissionsCallable,
    feature: Feature,
...
def test_project_user_without_view_project_permission_cannot_view_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_organisation_admin_can_edit_feature(  # noqa: FT003
    action: str,
    admin_user: FFAdminUser,
    feature: Feature,
) -> None:
...
@pytest.mark.parametrize("action", (("update"), ("partial_update")))
def test_project_admin_can_edit_feature(  # noqa: FT003
    action: str,
    staff_user: FFAdminUser,
    project: Project,
    feature: Feature,
...
@pytest.mark.parametrize("action", (("update"), ("partial_update")))
def test_project_user_cannot_edit_feature(  # noqa: FT003
    action: str,
    staff_user: FFAdminUser,
    with_project_permissions: WithProjectPermissionsCallable,
    feature: Feature,
...
def test_organisation_admin_can_delete_feature(  # noqa: FT003
    admin_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_project_admin_can_delete_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    feature: Feature,
    project: Project,
) -> None:
...
def test_project_user_with_delete_feature_permission_can_delete_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    with_project_permissions: WithProjectPermissionsCallable,
    feature: Feature,
) -> None:
...
def test_project_user_without_delete_feature_permission_cannot_delete_feature(  # noqa: FT003
    staff_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_organisation_admin_can_update_feature_segments(  # noqa: FT003
    admin_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_project_admin_can_update_feature_segments(  # noqa: FT003
    staff_user: FFAdminUser,
    project: Project,
    feature: Feature,
) -> None:
...
def test_project_user_cannot_update_feature_segments(  # noqa: FT003
    staff_user: FFAdminUser,
    feature: Feature,
) -> None:
    # Given
...
def test_nested_project_permissions_has_permission(  # type: ignore[no-untyped-def]  # noqa: FT003
...
def test_nested_project_permissions_has_object_permission(  # type: ignore[no-untyped-def]  # noqa: FT003
    action_permission_map,
    action,
    user_permission,
    expected_result,
