...
def test_multivariate_feature_options_view_set_get_permissions():  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_get_mv_feature_option_by_uuid(client, project, multivariate_feature):  # type: ignore[no-untyped-def]  # noqa: FT003
    # Given
...
def test_get_mv_feature_option_by_uuid_returns_404_if_mv_option_does_not_exists(  # type: ignore[no-untyped-def]  # noqa: FT003
    client, project
):
    # Given
    url = reverse(
