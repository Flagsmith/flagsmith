...
def test_migrate_feature_segments_forward(migrator: Migrator) -> None:  # noqa: FT003
...
def test_migrate_feature_segments_reverse(migrator: Migrator) -> None:  # noqa: FT003
...
def test_revert_feature_state_versioning_migrations(migrator: Migrator) -> None:  # noqa: FT003
    # Given
    old_state = migrator.apply_initial_migration(
...
def test_fix_feature_type_migration(migrator: Migrator) -> None:  # noqa: FT003
    # Given
    old_state = migrator.apply_initial_migration(
...
def test_migrate_sample_to_webhook_forward(migrator: Migrator) -> None:  # noqa: FT003
    # Given
    old_state = migrator.apply_initial_migration(
...
def test_migrate_sample_to_webhook_reverse(migrator: Migrator) -> None:  # noqa: FT003
    # Given
    old_state = migrator.apply_initial_migration(
        ("feature_health", "0003_migrate_sample_to_webhook")
    )
