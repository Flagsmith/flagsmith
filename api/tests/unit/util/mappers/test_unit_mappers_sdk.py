...
def test_map_environment_to_sdk_document__return_expected(  # noqa: FT003
...
def test_map_environment_to_sdk_document__for_environment_with_identity_overrides_in_local_eval_disabled(  # noqa: FT003
    mocker: "MockerFixture",
    environment: "Environment",
    feature_state: "FeatureState",
    identity: Identity,
