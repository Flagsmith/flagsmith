...
def test_get_current_site_url_returns_correct_url_if_site_exists(  # noqa: FT003
...
def test_get_current_site_url_uses_default_url_if_site_does_not_exist(  # noqa: FT003
    settings: "SettingsWrapper",
) -> None:
    # Given
    expected_domain = "some-testing-url.com"
...
def test_get_current_site__domain_override__with_site__return_expected(  # noqa: FT003
    settings: "SettingsWrapper",
) -> None:
    # Given
...
def test_get_current_site__domain_override__no_site__return_expected(  # noqa: FT003
    settings: "SettingsWrapper",
) -> None:
    # Given
    Site.objects.all().delete()
