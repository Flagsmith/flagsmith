...
@pytest.mark.parametrize(
    ...
    [
        (lazy_fixture("project"), lazy_fixture("admin_master_api_key"), 1),
        (lazy_fixture("project"), lazy_fixture("master_api_key"), 0),
        (
            lazy_fixture("organisation_two_project_one"),
            lazy_fixture("master_api_key"),
            0,
...
@pytest.mark.parametrize(
    "for_project, for_master_api_key, expected_count",
    [
        (lazy_fixture("project"), lazy_fixture("admin_master_api_key"), 2),
        (lazy_fixture("project"), lazy_fixture("master_api_key"), 0),
        (
            lazy_fixture("organisation_two_project_one"),
            lazy_fixture("master_api_key"),
