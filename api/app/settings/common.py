...
FRONTEND_FLAGSMITH_ON_FLAGSMITH_API_URL = env(
    "FLAGSMITH_ON_FLAGSMITH_API_URL", default=None
)
FRONTEND_FLAGSMITH_ON_FLAGSMITH_API_KEY = env(
    "FLAGSMITH_ON_FLAGSMITH_API_KEY", default=None
)
FRONTEND_PREVENT_SIGNUP = env.bool("PREVENT_SIGNUP", default=False)
FRONTEND_MAINTENANCE_MODE = env.bool("MAINTENANCE_MODE", default=False)
FRONTEND_DISABLE_INFLUXDB_FEATURES = env.bool("DISABLE_INFLUXDB_FEATURES", default=True)
FRONTEND_FLAGSMITH_ANALYTICS = env.bool("FLAGSMITH_ANALYTICS", default=False)
FRONTEND_LINKEDIN_API_KEY = env("LINKEDIN_API_KEY", default=None)
FRONTEND_GOOGLE_ANALYTICS_API_KEY = env("GOOGLE_ANALYTICS_API_KEY", default=None)
FRONTEND_CRISP_CHAT_API_KEY = env("CRISP_CHAT_API_KEY", default=None)
FRONTEND_MIXPANEL_API_KEY = env("MIXPANEL_API_KEY", default=None)
FRONTEND_SENTRY_API_KEY = env("SENTRY_API_KEY", default=None)
FRONTEND_AMPLITUDE_API_KEY = env("AMPLITUDE_API_KEY", default=None)
