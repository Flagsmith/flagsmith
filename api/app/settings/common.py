...
TASK_PROCESSOR_DATABASE_URL = env("DJANGO_DB_URL_TASK_PROCESSOR", default=None)
TASK_PROCESSOR_DATABASE_USER = env("DJANGO_DB_USER_TASK_PROCESSOR", default=None)
TASK_PROCESSOR_DATABASE_PASSWORD = env(
    "DJANGO_DB_PASSWORD_TASK_PROCESSOR",
    default=None,
)
TASK_PROCESSOR_DATABASE_HOST = env("DJANGO_DB_HOST_TASK_PROCESSOR", default=None)
TASK_PROCESSOR_DATABASE_PORT = env("DJANGO_DB_PORT_TASK_PROCESSOR", default=None)
TASK_PROCESSOR_DATABASE_NAME = env("DJANGO_DB_NAME_TASK_PROCESSOR", default=None)

TASK_PROCESSOR_DATABASE_IS_ENABLED = bool(
    TASK_PROCESSOR_DATABASE_URL or TASK_PROCESSOR_DATABASE_NAME
)
if TASK_PROCESSOR_DATABASE_IS_ENABLED:
