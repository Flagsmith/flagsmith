...
class WebhookEventType(enum.Enum):
    ...
    FLAG_FEATURE_CREATED = "FLAG_FEATURE_CREATED"
    FLAG_FEATURE_DELETED = "FLAG_FEATURE_DELETED"
    FLAG_FEATURE_UPDATED = "FLAG_FEATURE_UPDATED"

    FLAG_IDENTITY_UPDATED = "FLAG_IDENTITY_UPDATED"

    FLAG_SEGMENT_CREATED = "FLAG_SEGMENT_CREATED"
    FLAG_SEGMENT_DELETED = "FLAG_SEGMENT_DELETED"
    FLAG_SEGMENT_UPDATED = "FLAG_SEGMENT_UPDATED"
