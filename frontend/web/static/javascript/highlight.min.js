...
var hljs = (function () {
      ...
      contains: [
        {
          ...
          contains: [
            w,
            { begin: /\[/, end: /\]/, relevance: 0, contains: [w] },
          ],
        },
      ],
    },
  ...
  const H = {},
    ...
    z = (e, t) => {
      H[`${e}/${t}`] ||
        (console.log(`Deprecated as of ${e}. ${t}`), (H[`${e}/${t}`] = !0))
    },
    K = Error()
      ...
      ((e) => {
        if (Array.isArray(e.end)) {
          ...
          if ('object' != typeof e.endScope || null === e.endScope)
            throw ($('endScope must be object'), K)
  ...
  var J = ((e) => {
      ...
      function h(e, n, r, s) {
        ...
        function p(e, t) {
          return (
            e.scope &&
              ...
              S.openNode(_.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (S.addKeyword(
                    M,
        ...
        function w(t, s) {
          ...
          if (((y = s), 'begin' === s.type))
            return ((e) => {
              ...
              for (const n of s)
                if (n && (n(e, r), r.isMatchIgnored)) return m(t)
              return (
                n.skip
                  ? (M += t)
                  : (n.excludeBegin && (M += t),
        ...
        const _ = E(e)
        if (!_)
          throw ($(a.replace('{}', e)), Error('Unknown language: "' + e + '"'))
        const v = G(_)
        let O = '',
          k = s || v
        const N = {},
      ...
      function m() {
        'loading' !== document.readyState
          ? document.querySelectorAll(g.cssSelector).forEach(p)
          : (b = !0)
      }
      function E(e) {
    ...
    return (a) => {
      ...
      return (
        c.unshift(b),
        {
          ...
          keywords: s,
          illegal: /\/\*/,
          contains: [a.SHEBANG({ binary: 'ruby' })]
            .concat(E)
            .concat(c)
            .concat(_),
        }
  ...
  (() => {
    ...
    return (b) => {
      ...
      const h = [].concat(v, _.contains),
        S = h.concat([
          { begin: /\(/, end: /\)/, keywords: u, contains: ['self'].concat(h) },
        ]),
        w = {
          className: 'params',
          begin: /\(/,
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (n) => {
      const a = /(?:(?:[a-zA-Z]|\.[._a-zA-Z])[._a-zA-Z0-9]*)|\.(?!\d)/,
        i = e(
            ...
            contains: [
              ...
              },
              {
                ...
                contains: [
                  {
                    scope: 'variable',
                    variants: [{ begin: a }, { begin: /`(?:\\.|[^`\\])+`/ }],
                    endsParent: !0,
                  },
                ],
              },
              { scope: 'doctag', begin: /@[a-zA-Z]+/ },
              { scope: 'keyword', begin: /\\[a-zA-Z]+/ },
            ],
          }),
          n.HASH_COMMENT_MODE,
          {
  ...
  (() => {
    ...
    function e(e) {
      return ((...e) =>
        e
          .map((e) =>
            ((e) => (e ? ('string' == typeof e ? e : e.source) : null))(e),
          )
          .join(''))('(?:', e, ')?')
    }
    return (n) => {
      const t = n.COMMENT('//', '$', { contains: [{ begin: /\\\n/ }] }),
        s = '[a-zA-Z_]\\w*::',
        r =
          '(decltype\\(auto\\)|' + e(s) + '[a-zA-Z_]\\w*' + e('<[^<>]+>') + ')',
        a = {
          className: 'type',
          variants: [
            { begin: '\\b[a-z\\d_]*_t\\b' },
        ...
        g = [c, a, t, n.C_BLOCK_COMMENT_MODE, l, i],
        m = {
          variants: [
            { begin: /=/, end: /;/ },
            {
      ...
      return {
        ...
        exports: { preprocessor: c, strings: i, keywords: u },
      }
    }
  })(),
)
  ...
  (() => {
    ...
    const t = '[a-zA-Z]\\w*',
      a = (t, a, s = {}) => {
        ...
        })({ scope: 'comment', begin: t, end: a, contains: [] }, s)
        i.contains.push({
          scope: 'doctag',
          begin: '[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)',
          end: /(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,
  ...
  (() => {
    ...
    return (e) => {
      const r = /[dualxmsipngr]{0,12}/,
        ...
        i = { className: 'subst', begin: '[$@]\\{', end: '\\}', keywords: s },
        a = { begin: /->\{/, end: /\}/ },
        o = {
          variants: [
            { begin: /\$\d/ },
      ...
      return (
        (i.contains = p),
        (a.contains = p),
        { name: 'Perl', aliases: ['pl', 'pm'], keywords: s, contains: p }
      )
    }
  })(),
)
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (n) => {
      ...
      var m
      const g = [_, l, s, a, n.C_BLOCK_COMMENT_MODE, o, c],
        f = {
          variants: [
            { begin: /=/, end: /;/ },
            { begin: /\(/, end: /\)/ },
        ...
        b = {
          ...
          illegal: /[^\w\s\*&:<>.]/,
          contains: [
            { begin: 'decltype\\(auto\\)', keywords: p, relevance: 0 },
            { begin: d, returnBegin: !0, contains: [u], relevance: 0 },
            { begin: /::/, relevance: 0 },
            { begin: /:/, endsWithParent: !0, contains: [c, o] },
            { relevance: 0, match: /,/ },
            {
              className: 'params',
              begin: /\(/,
              ...
              contains: [
                ...
                s,
                {
                  ...
                  keywords: p,
                  relevance: 0,
                  contains: ['self', a, n.C_BLOCK_COMMENT_MODE, c, o, s],
                },
              ],
            },
            s,
        ...
        q = [
          {
            ...
            starts: {
              contains: [
                { begin: /\(/, end: /\)/, keywords: E, contains: [...M, I, P] },
              ],
            },
          },
  ...
  (() => {
    ...
    return (a) => {
      const s = ((e) => ({
        ...
        u = { begin: '\\(', end: '\\)', contains: g, keywords: p, relevance: 0 }
      g.push(
        a.C_LINE_COMMENT_MODE,
        a.C_BLOCK_COMMENT_MODE,
        b("'"),
      ...
      const h = g.concat({ begin: /\{/, end: /\}/, contains: c }),
        f = {
          beginKeywords: 'when',
          endsWithParent: !0,
    ...
    function t(...r) {
      return (
        ...
        (((e) => {
          ...
          return 'object' == typeof r && r.constructor === Object
            ? (e.splice(e.length - 1, 1), r)
            : {}
        })(r).capture
          ? ''
          : '?:') +
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (b) => {
        ...
        m = (function (b) {
          ...
          const k = {
            ...
            C =
              ...
              ')\\s*=>',
            B = {
              match: [/const|var|let/, /\s+/, d, /\s*/, /=\s*/, o(C)],
              className: { 1: 'keyword', 3: 'title.function' },
              contains: [S],
            }
          return {
            ...
            contains: [
              ...
              y,
              R,
              { className: 'attr', begin: d + o(':'), relevance: 0 },
              B,
              {
                begin:
                  '(' + b.RE_STARTERS_RE + '|\\b(case|return|throw)\\b)\\s*',
                keywords: 'return throw case',
                relevance: 0,
                contains: [
                  A,
      ...
      return (
        Object.assign(m.keywords, d),
        m.exports.PARAMS_CONTAINS.push(g),
        ...
        u(m, 'shebang', b.SHEBANG()),
        u(m, 'use_strict', {
          className: 'meta',
          relevance: 10,
          begin: /^\s*['"]use strict['"]/,
        }),
        (m.contains.find((e) => 'func.def' === e.label).relevance = 0),
        Object.assign(m, {
          name: 'TypeScript',
          aliases: ['ts', 'tsx'],
        }),
