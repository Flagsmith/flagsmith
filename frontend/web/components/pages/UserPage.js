                            ...
                            <PanelSearch
                              ...
                              renderRow={({ id, name }, i) => {
                                ...
                                const environmentFlag =
                                  (environmentFlags && environmentFlags[id]) ||
                                  {}
                                ...
                                const onClick = () => {
                                  if (manageUserPermission) {
                                    this.editFeature(
                                      ...
                                      environmentFlags && environmentFlags[id],
                                      (identityFlags && identityFlags[id]) ||
                                        actualFlags[name],
                                      identityFlags &&
                                        identityFlags[id] &&
                                        identityFlags[id]
                                    ...
                                    >
                                      ...
                                      {hasUserOverride ? (
                                          ...
                                          <Row>
                                            <Flex>
                                              {isMultiVariateOverride ? (
                                                <span>
                                                  This flag is being overridden
                                                  by a variation defined on your
                                                ...
                                                <span>
                                                  This flag is being overridden
                                                  by segments and would normally
                                                  be{' '}
                                                  <strong>
                                                    {flagEnabled ? 'on' : 'off'}
                                                  </strong>{' '}
                                        ...
                                        isMultiVariateOverride ? (
                                          ...
                                          >
                                            <span>
                                              This feature is being overriden by
                                              a % variation in the environment,
                                              the control value of this feature
                                              is{' '}
                                              <FeatureValue
                                                includeEmpty
                                          ...
                                          >
                                            <span>
                                              This feature is being overriden by
                                              segments and would normally be{' '}
                                              <FeatureValue
                                                includeEmpty
                                                data-test={`user-feature-original-value-${i}`}
                                                value={`${flagValue}`}
