...
import { Invite, InviteLink, Organisation, SubscriptionMeta, User, UserGroupSummary } from 'common/types/responses';
...
subscriptionMeta,
    ...
    const roleChanged = (id:string, { value: role }:{value:string}) => {
                                            ...
                                            <FormGroup className='mt-2'>
                                                ...
                                                <PanelSearch
                                                    ...
                                                    renderRow={(user, i) => {
                                                        ...
                                                        const onEditClick = () => {
                                                            if (role !== 'ADMIN') {
                                                                this.editUserPermissions(user, organisation.id)
                                                            }
                                                        }
                                                        return (
                                                            <Row
  ...
  return (
      ...
      <OrganisationProvider id={AccountStore.getOrganisation()?.id}>
        {({
            ...
            return <UsersAndPermissionsInner organisation={organisation}
