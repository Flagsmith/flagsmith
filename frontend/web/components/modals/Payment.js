                ...
                <div className='col-md-12'>
                      ...
                      <div className='panel panel-default'>
                        <div className='panel-content p-3 pt-4'>
                          <span className='featured text-body'>
                            Optional <a className='text-primary fw-bold' target='_blank'
                                        href='https://www.flagsmith.com/on-premises-and-private-cloud-hosting'
                          >On Premise</a> or <a className='text-primary fw-bold' target='_blank'
                                                href='https://www.flagsmith.com/on-premises-and-private-cloud-hosting'
                          >Private Cloud</a> Install
                          </span>
                          <Row className='pt-4 justify-content-center'>
                  ...
                  <div className='text-center mt-4'>
                    *Need something in-between our Enterprise plan for users or API limits?
                    <div>
                      <a href={'https://www.flagsmith.com/contact-us'}>Reach out</a> to us and we'll
                      help you out
                    </div>
                  </div>
                </div>
