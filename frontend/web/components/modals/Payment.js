                        ...
                        <div className='panel panel-default'>
                          ...
                          <div className='panel-footer'>
                            ...
                            <ul className='pricing-features'>
                              ...
                              <li>
                                <p>Unlimited Feature Flags</p>
                              </li>
                              <li>
                                <p>Unlimited Identities and Segments</p>
                              </li>
                              <li>
                                <p>3rd Party Integrations</p>
                              </li>
                              <li>
                                <p>A/B and MVT Testing</p>
                              </li>
                              <li>
                                <p>Email Technical Support</p>
                              </li>
                              <li>
                      ...
                      <div className='col-md-4 pricing-panel'>
                        <div className='panel panel-default'>
                          <div className='panel-content'>
                            ...
                            <img
                              src='/static/images/pricing-scale-up.svg'
                              alt='Scale-up icon'
                              className='pricing-icon'
                            />
                            <p className='pricing-type'>
                          ...
                          <div className='panel-footer'>
                            ...
                            <ul className='pricing-features'>
                              <li>
                                <p>
                                  Up to <strong>5,000,000</strong> requests per
                                  month
                                </p>
                              </li>
                              <li>
                              ...
                              <li>
                                <p>2FA and SAML Authentication</p>
                              </li>
                              <li>
                                <p>Online Ts and Cs</p>
                              </li>
                        ...
                        <div className='panel panel-default'>
                          ...
                          <div className='panel-footer'>
                            ...
                            <ul className='pricing-features'>
                              <li>
                                <p>
                                  <strong>5,000,000 +</strong> requests per
                                  month
                                </p>
                              </li>
                              <li>
                              ...
                              <li>
                                <p>Uptime and Support SLA</p>
                              </li>
                              <li>
                                <p>On-Boarding &amp; Training</p>
                              </li>
                              <li>
                                <p>Amendable MSA</p>
                              </li>
                              <li>
                                <p>Optional On Premise Installation</p>
                              </li>
                            </ul>
                          </div>
                        </div>
