...
import EditFeatureValue from './EditFeatureValue'
import FeatureValueTab from './tabs/FeatureValueTab'
import CreateFeatureTab from './tabs/CreateFeatureTab'

const CreateEditFeature = class extends Component {
  static displayName = 'CreateEditFeature'
        ...
        <>
          ...
          <EditFeatureValue
            ...
            featureState={{
              ...
              multivariate_feature_state_values: this.state.identityVariations,
            }}
            ...
            onChange={(featureState) => {
              ...
              if (featureState.enabled !== undefined) {
                updates.default_enabled = featureState.enabled
              }
              if (featureState.feature_state_value !== undefined) {
                updates.initial_value = featureState.feature_state_value
                                  ...
                                  >
                                    <FeatureValueTab
                                      ...
                                      environmentVariations={
                                        this.state.environmentVariations
                                      }
                                      default_enabled={
                                        this.state.default_enabled
                                      }
...
const WrappedCreateFlag = ConfigProvider(withSegmentOverrides(CreateEditFeature))
