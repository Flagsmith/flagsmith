        ...
        {({ isLoading, userGroups, userGroupsPaging }) => (
          <FormGroup>
            <PanelSearch
              ...
              nextPage={() =>
                AppActions.getGroupsPage(
                  this.props.orgId,
                  userGroupsPaging.next,
                )
              }
              prevPage={() =>
                AppActions.getGroupsPage(
                  this.props.orgId,
                  userGroupsPaging.previous,
                )
              }
              goToPage={(page) =>
                AppActions.getGroupsPage(
                  this.props.orgId,
                  `${Project.api}organisations/${this.props.orgId}/groups/?page=${page}`,
                )
              }
              renderRow={(group, index) => {
                ...
                const onClick = () => {
                  if (this.props.onClick) {
                    ...
                    openModal(
                      'Edit Group',
                      <CreateGroup orgId={this.props.orgId} group={group} />,
                    )
                  }
                }
                return (
                  ...
                  >
                    ...
                    {this.props.onEditPermissions && isAdmin && (
                      <Button
                        onClick={() => this.props.onEditPermissions(group)}
                        className='btn--link'
                      >
                        Edit Permissions
                      </Button>
