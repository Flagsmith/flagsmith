...
!(function (e) {
  ...
  typeof exports !== 'undefined'
    ...
    : n &&
      ((n.hljs = e({})),
      typeof define === 'function' && define.amd && define([], () => n.hljs))
})((e) => {
  function n(e) {
  ...
  function l(e) {
    return (
      e.v &&
        !e.cached_variants &&
        (e.cached_variants = e.v.map((n) => o(e, { v: null }, n))),
...
hljs.registerLanguage('php', (e) => {
  const c = { b: '\\$+[a-zA-Z_-Ã¿][a-zA-Z0-9_-Ã¿]*' }
  ...
  return {
    ...
    c: [
      ...
      a,
      {
        b: /[{,]\s*/,
        r: 0,
        c: [{ b: `${r}\\s*:`, r: 0, rB: !0, c: [{ b: r, cN: 'attr', r: 0 }] }],
      },
      {
