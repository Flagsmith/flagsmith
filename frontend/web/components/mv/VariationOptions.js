    ...
    return (
        <>
            ...
            {!preventRemove && (
                <p>
                    <InfoMessage>
                        Variation values are shared amongst environments. Variation weights are specific to this Environment. Variations will only apply when you identify via the SDK, otherwise the control value will be used. <a target="_blank" href="https://docs.flagsmith.com/basic-features/managing-features#multi-variate-flags">Check the Docs for more details.</a>.
                    </InfoMessage>
                </p>
            )}
