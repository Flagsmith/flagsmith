...
export default async function () {
  ...
  log('Create Organisation', 'Segment Test');
  ...
  log('Create Project', 'Segment Test');
  ...
  log('Segment age rules', 'Segment Test')
  await gotoSegments()
  ...
  log('Add segment trait for user', 'Segment Test')
  await gotoTraits()
  ...
  log('Set user MV override', 'Segment Test')
  ...
  log('Delete segment', 'Segment Test')
  await gotoSegments()
