...
export const AllTokens: StoryObj = {
  ...
  render: () => (
    ...
    >
      ...
      <table className='docs-table'>
        ...
        <tbody>
          <tr>
            ...
            <td>No spacing. Use for flush edges between elements.</td>
          </tr>
          <tr>
            <td>
              <code>--space-1</code>
            ...
            <td>Tight inline spacing. Icon-to-text gap, badge padding.</td>
          </tr>
          <tr>
            <td>
              <code>--space-2</code>
          ...
          <tr>
            ...
            <td>
              Standard component padding. Card padding, section gap, button
              horizontal padding.
            </td>
          </tr>
          <tr>
            ...
            <td>Button horizontal padding (large). Modal body padding.</td>
          </tr>
          <tr>
            <td>
              <code>--space-6</code>
            ...
            <td>
              Section spacing. Gap between card groups, modal header/body
              padding.
            </td>
          </tr>
          <tr>
            ...
            <td>Large section spacing. Page section margins.</td>
          </tr>
          <tr>
            <td>
              <code>--space-10</code>
            ...
            <td>Extra-large spacing. Major page sections.</td>
          </tr>
          <tr>
            <td>
              <code>--space-12</code>
            ...
            <td>Page-level vertical spacing between major sections.</td>
          </tr>
          <tr>
            <td>
              <code>--space-16</code>
            ...
            <td>Maximum spacing. Hero sections, page-level separation.</td>
          </tr>
          <tr>
            <td>
              <code>--space-0_5</code>
      ...
      <ul>
        <li>
          <strong>Icon-to-text gap:</strong> --space-1 (4px) or --space-2 (8px)
        </li>
        <li>
          <strong>Component inner padding:</strong> --space-3 (12px) to
          --space-4 (16px)
        </li>
        <li>
          <strong>Between components:</strong> --space-4 (16px) to --space-6
          (24px)
        </li>
        <li>
          <strong>Page sections:</strong> --space-8 (32px) and above
        </li>
      </ul>
