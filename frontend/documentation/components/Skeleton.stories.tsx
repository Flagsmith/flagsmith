...
- Skeleton elements are decorative — screen readers skip them
  ...
  render: () => (
    <div className='d-flex flex-column gap-4' style={{ maxWidth: 640 }}>
      <section>
        <h6 className='mb-2'>Use Skeleton when</h6>
        <ul className='mb-0'>
          <li>
            Loading data from an API and you want to show the layout shape
            before content arrives
          </li>
          <li>
            The content area has a predictable structure (list rows, cards, form
            fields)
          </li>
          <li>
            You want to reduce perceived loading time by showing a placeholder
      ...
      <section>
        <h6 className='mb-2'>Don't use Skeleton when</h6>
        <ul className='mb-0'>
          <li>
            The loading state is brief (&lt;200ms) — use a spinner instead
          </li>
          ...
          <li>You're loading a single value — inline spinners work better</li>
        </ul>
      </section>
      <section>
        ...
        <ul className='mb-0'>
          ...
          <li>Skeleton elements are decorative — screen readers skip them</li>
        </ul>
      </section>
      <section>
        <h6 className='mb-2'>Example</h6>
